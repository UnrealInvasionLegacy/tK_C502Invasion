class C5GasBag extends Monster;
...
defaultproperties
{
     ...
     AmmunitionClass=Class'tk_C502Invasion.C5GasbagAmmo'
     ScoringValue=6
     bCanFly=True
     AirSpeed=375.000000
     Health=150
     ...
     Skins(0)=Texture'tk_C502Invasion.TrashBag.TrashBag'
     Skins(1)=Texture'tk_C502Invasion.TrashBag.TrashBag'
